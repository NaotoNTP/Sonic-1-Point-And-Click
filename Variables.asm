...
v_mouse_xprev:		equ $FFFFF5DE

v_mouse_regx:		equ $FFFFF5E0
v_mouse_regy:		equ $FFFFF5E2

v_mouse_scrxprev:	equ $FFFFF5E4
...
v_mouse_screenx:	equ $FFFFF5F2
v_mouse_screeny:	equ $FFFFF5F4

v_mouse_worldx:		equ $FFFFF5F6
v_mouse_worldy:		equ $FFFFF5F8

v_mouse_velx:	equ $FFFFF5FA
v_mouse_vely:	equ $FFFFF5FC

v_mouse_hurttimer:	equ $FFFFF5FE
v_mouse_gfxindex:	equ $FFFFF5FF

v_gamemode:	equ $FFFFF600	; game mode (00=Sega; 04=Title; 08=Demo; 0C=Level; 10=SS; 14=Cont; 18=End; 1C=Credit; +8C=PreLevel)

v_signpost:	equ $FFFFF601
...
v_mouse_hold:	equ $FFFFF606
v_mouse_press:	equ $FFFFF607

v_waterfall_unpause: equ $FFFFF608
v_boss_clicked:	equ $FFFFF609

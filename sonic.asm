...
Title_Local:	dc.b "SONIC 1 BUT YOU CAN CLICK ON EVERYTHING         " ; Domestic name
Title_Int:	dc.b "SONIC 1 BUT YOU CAN CLICK ON EVERYTHING         " ; International name
...
GameInit:
	...
	@cursor:
		move.w	(a5)+,(a6)
		dbf	d1,@cursor		; NTP: transfer mouse cursor art
...
Art_Cursor:	incbin	"artunc\Cursor.bin" ; NTP: art for the mouse pointer
		even
...
ReadMouse:
		...
		move.b	#$60,(a1)		; set first phase of packet
		or.l	d0,d0			; wait 8 cycles
...
GM_Title:
	...
	Tit_ClrPal:
		...
		lea	(vdp_data_port).l,a6
		locVRAM	$D000,4(a6)
		lea	(Art_Text).w,a5	; load level select font
		move.w	#$28F,d1
...
Smash_FragSpd3:	dc.w -$400, -$400	; x-speed, y-speed
		dc.w -$300, -$300
		dc.w -$200, -$200
		dc.w -$100, -$100
		dc.w $400, -$400
